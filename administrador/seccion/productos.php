...
<div class="col-md-5">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <input type="text" readonly class="form-control" value="<?php echo $txtNombre?>" name="txtNombre" id="txtNombre" placeholder="Nombre del equipo">
            </div>

            <div class = "form-group">
            <label for="txtNombre">Serie:</label>
            <input type="text" readonly class="form-control" value="<?php echo $txtSerie?>" name="txtSerie" id="txtSerie" placeholder="Serie del equipo">
            </div>
            ...
            <?php /* <input type="file" class="form-control" name="txtImagen" id="txtImagen" placeholder="Nombre"> */ ?>
            </div>

            <div class="btn-group" role="group" aria-label="">
                <?php /*<button type="submit" name="accion" <?php echo($accion=="Seleccionar" || $accion=="Borrar")?"disabled":"" ?> value="Agregar" class="btn btn-success">Agregar</button> */ ?>
                <?php /* <button type="submit" name="accion" <?php echo($accion!="Seleccionar")?"disabled":"" ?> value="Modificar" class="btn btn-warning">Modificar</button> */ ?>
            ...
            <tr>
                ...
                <td>
                    <form method="post">
                       ...
                       <?php /* <input type="submit" name="accion" value="Borrar" class="btn btn-danger" />  */ ?>
